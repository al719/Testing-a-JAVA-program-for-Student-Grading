...
public class DataAnalyzer {
	...
	// course  builder : object used to invoke build fcn to build course  object with its data
	Course_Builder course_build;
...
//					course_build.setCourse(subject);
				...
				if(student_validator.isValid(Data_Line[0],Data_Line[1],Data_Line[2],Data_Line[3],Data_Line[4],Data_Line[5])) {
					...
					student_build = new Student_Builder(Data_Line[0],Data_Line[1],Integer.parseInt(Data_Line[2]),Integer.parseInt(Data_Line[3]),Integer.parseInt(Data_Line[4]),Integer.parseInt(Data_Line[5]),student_GPA,student_grade);;
